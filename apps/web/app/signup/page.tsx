...
export const metadata: Metadata = {
  title: "Sign Up - Forceweaver",
  description: "Create your Forceweaver account to access Rev Cloud Blueprint Pro features.",
};
  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <SignupForm redirectUri={redirectUri} redirectTo={redirectTo} />
      </div>
    </div>
  );
}
