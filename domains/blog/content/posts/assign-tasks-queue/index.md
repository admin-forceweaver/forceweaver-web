...
author: ''
excerpt: >-
  During my salesforce journey, I’ve come across multiple scenarios where
  customer provides a way of open work culture within a team and with salesforce
  it was always easy with the use of queues. For e.g.
category: Tutorial
tags:
  - assign-task
  - assign-task-group
...
![task_queue](images/task_queue.png)
...
![task_options](images/task_queue_options.png)

![task_record](images/task_queue_record.png)
...
![task_view](images/task_queue_record_view.png)
...
![task_no_option](images/task_queue_no_options.png)
